...
<html>
	<head>
		...
		<script type="text/javascript" src="/scripts/basedata/logDb_dayCallInfo.js"></script>
		...
		<script type="text/javascript" src="/scripts/lib/map.js"></script>
	...
	<div style="padding: 15px">
		<form id="search-form"  role="form" class="form-inline" >
			<div class="row">
				...
				<div class="form-group col-md-3">
					<label for="query_rows">Rows>=:</label>
