...
<html>
	<head>
		...
		<script type="text/javascript" src="/scripts/lib/comm.dict_CN.js"></script>
		<script type="text/javascript" src="/scripts/lib/Common.js"></script>
		<script type="text/javascript" src="/scripts/basedata/logDb_dayCallCount.js"></script>
		...
		<script src="/scripts/lib/highcharts4.2/highcharts.js"></script>
		<script src="/scripts/lib/highcharts4.2/modules/exporting.js"></script>
		<style>
