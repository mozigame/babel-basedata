...
public class Menu {
	...
	public Menu(ModulePO m){
		this.MENU_ID=""+m.getCid();
		this.PARENT_ID=""+m.getParentId();
		this.MENU_NAME=m.getName();
		this.MENU_ICON=m.getIcon();
		this.MENU_URL=m.getUrl();
		this.MENU_ORDER=""+m.getOrderCount();
